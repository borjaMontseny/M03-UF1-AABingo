...
public class Bingo {
	...
	public static void main(String[] args) {
		...
		// reutilitzem el validador d'avans, pero ara validant M
		...
		while (numIntroduit != -1) {
			...
			// extra. per a validar que el num es entre 1 i 99 i tampoc -1, i mostrar cartró
			while (!rangValid) {
				// mostrem el cartró al jugador
				System.out.println("\nEl teu cartró:");
		...
		if (numIntroduit == -1) {
			...
			if ((numN * numM) == contadorTatxats) {
				...
				System.out.println("La mitjana dels números que no has pogut tatxar és " + mitjanaNoTatxats + ".");
			}
